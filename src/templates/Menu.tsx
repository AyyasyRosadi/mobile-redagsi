  ...
  return (
    <SafeAreaView>
      <View className="h-[65px] absolute bottom-0 bg-[#dcb535] flex-1 w-[100%] flex flex-row justify-between py-2 px-3 shadow-xl">
        <View className="w-[18%]" onTouchStart={() => navigate.navigate("Gaji")}>
        ...
        <View className="w-[18%]" onTouchStart={() => navigate.navigate("Riwayat")}>
        ...
        <View className="w-[22%] -mt-[10%] bg-sky-600 rounded-full p-3 shadow-2xl shadow-white" onTouchStart={() => navigate.navigate("Home")}>
        ...
        <View className="w-[18%]" onTouchStart={() => navigate.navigate("Qr")}>
        ...
        <View className="w-[18%]" onTouchStart={() => navigate.navigate("Profile")}>
